...
const BenchmarkCard = () => {
  ...
  const metrics = [
    ...
    { label: 'Burnout Risk', value: data.metrics.burnout_percentile, icon: <ShieldAlert size={16} /> } // Higher percentile = lower risk/better
  ];

  // Logic for UI mapping colors dynamically
  const getColor = (val) => {
